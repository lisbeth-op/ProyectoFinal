...
namespace BLL
{
    public class OrdenesProduccionBLL
    {
        ...
        public bool Modificar(OrdenDeProducciones orden)
        {
            ...
            _contexto.Database.ExecuteSqlRaw($"Delete from DetalleOrdenDeProduccions where OrdenDeProduccionId={orden.OrdenDeProduccionId}");
        ...
        public OrdenDeProducciones? Buscar(int id)
        {
            OrdenDeProducciones? orden;

            try
            {
                orden = _contexto.OrdenDeProducciones.FirstOrDefault(op => op.OrdenDeProduccionId == id);
            }
            catch (Exception)
            {
                throw;
        ...
        public List<OrdenDeProducciones> GetList()
        {
